export const projects = [
    {
        ...
        byline:"I was involved in developing multiple projects built within Joy Business Academy's online learning platform and marketing site, including chat functionality between employers and learners, as well as an interactive profile for the user to complete. My role in these projects was as lead developer, working woth several developers from my team.",
    ...
    },
    {
        ...
        byline:"Interactive Microsite hosted on the nzherald.co.nz, where users could enter a competition about hotspots in Auckland city. This was built using HTML5, CSS3, and JS/jQuery. I was the sole developer on this project and worked with the campaign manager and designers from the idea conception through to the live release.",
    ...
    {
        name:"#ASBFarmsmarts",
        byline:"NZHerald online campaign. I was the sole developer on this project, and used EngageSciences software to manage to competition. I liased with the internal team managing this campaign, as well as the Wayin team in Australia who provided support for custom features.",
    ...
    {
        name:"Autolife",
        byline:"Wordpress CMS marketing and quote website. I was the lead developer on this site, where I worked with the account manager and the client to create a bespoke solution for their business.",
    ...
    {
        name:"Paper Room",
        byline:"Wordpress CMS e-commerce website. I was a contributing developer on this project, which was led by my team's lead developer. I worked with the client and provided support for them through the development process. My main contribution to this site was to work on templates to match them to the design.",
        ...
        },
        {
            ...
            caption: "A single product page, with multiple product sizes to select from, and related products column."
        }
    ...
    },
    {
        ...
        byline:"Wordpress CMS marketing website. I was the lead developer on this site, and created a custom theme for this client using Thesis theme.",
    ...
    },
    {
        ...
        byline:"Single page marketing site. I was the lead developer on this single page brochure site for a local small business. This site was created using HTML5, CSS, and a small amount of jQuery.",
        ...
        images: [
        {
            ...
            caption: "A simple but visually appealing outline of the company's main products."
        },
        {
